...
exports.TOOL_POST_MESSAGE = exports.TOOL_GET_CONTEXT = void 0;
...
exports.TOOL_GET_CONTEXT = TOOL_GET_CONTEXT;
const TOOL_POST_MESSAGE = 'cat_cafe_post_message';
exports.TOOL_POST_MESSAGE = TOOL_POST_MESSAGE;
/**
 * 获取必需的环境变量
 */
...
async function startMcpServer() {
    ...
    // 注册 post_message 工具
    server.registerTool(TOOL_POST_MESSAGE, {
        title: 'Post Message',
        ...
        inputSchema: zod_1.z.object({
            content: zod_1.z.string().min(1).describe('Final public content to send to the chat room. Should be polished and ready for the user to see.')
        })
    }, async ({ content }) => {
        try {
    ...
    // 注册 get_context 工具
    server.registerTool(TOOL_GET_CONTEXT, {
        title: 'Get Context',
...
//# sourceMappingURL=cat-cafe-mcp.js.map