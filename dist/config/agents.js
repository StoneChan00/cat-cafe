...
exports.AGENT_ALIASES = exports.AGENT_CONFIGS = exports.MODEL_IDS = void 0;
exports.getAgentConfig = getAgentConfig;
exports.getAllAgentConfigs = getAllAgentConfigs;
exports.resolveAgentAlias = resolveAgentAlias;
...
exports.AGENT_CONFIGS = {
    developer: {
        id: 'developer',
        name: '开发猫',
        model: exports.MODEL_IDS.developer,
    ...
    reviewer: {
        id: 'reviewer',
        name: '审查猫',
        model: exports.MODEL_IDS.reviewer,
    ...
    creative: {
        id: 'creative',
        name: '创意猫',
        model: exports.MODEL_IDS.creative,
...
function getAgentConfig(agentId) {
    return exports.AGENT_CONFIGS[agentId];
}
/**
 * 获取所有 Agent 配置
 */
function getAllAgentConfigs() {
    return Object.values(exports.AGENT_CONFIGS);
}
/**
...
function resolveAgentAlias(alias) {
    ...
    return exports.AGENT_ALIASES[normalized] || null;
}
/**
 * 检查是否为有效的 Agent 角色
 */
function isValidAgentRole(role) {
    return role in exports.AGENT_CONFIGS;
}
