...
import type { AgentConfig, ThreadContext, MetaRule, PromptBuildContext, AgentRole } from '../types';
 ...
 */
function buildOriginalGoalSummary(threadContext?: ThreadContext): string {
...
export function buildReviewPrompt(
  ...
  // 2. 元规则
  const metaRulesSection = buildMetaRulesSection(DEFAULT_META_RULES);
  if (metaRulesSection) {
    parts.push(metaRulesSection);
  }
